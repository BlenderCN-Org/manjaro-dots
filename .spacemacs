...
;;  (spacemacs/load-theme 'solarized)
  ...
  ;;E lá vamos nós de novo não é mesmo
...
(helm-selection :foreground "white" :background "#073642" :inverse-video nil)
...
(custom-set-faces
 ...
 '(font-lock-comment-face ((t (:background "#002B36" :foreground "#586e75" :slant italic))))
